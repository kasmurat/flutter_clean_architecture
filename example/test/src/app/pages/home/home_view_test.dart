...
void main() {
  testWidgets('Given Add Button when click then increment counter and display Button pressed 1 times. text',
      (tester) async {
  ...
  testWidgets('Given Get User Button when click then display John Smith, 18 text', (tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: HomePage(key: Key('homePage'), title: 'Flutter Demo Home Page'),
    ));
    expect(find.byKey(const Key('homePage')), findsOneWidget);
