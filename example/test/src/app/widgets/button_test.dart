...
void main() {
  testWidgets('Given stateless button when homepagebutton is added to parent widget then return homepagebutton',
      (tester) async {
...
class TestPageState extends ViewState<TestPage, HomeController> {
  ...
  @override
  Widget get view => Scaffold(key: globalKey, body: const HomePageButton(text: 'Get User'));
}
